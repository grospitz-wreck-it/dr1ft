...
import { Shield, Users, BookOpen, BarChart3, ArrowRight, Building2, GraduationCap, School } from "lucide-react";
...
export default function HomePage() {
  return (
    <>
      ...
      <section className="bg-[#060A16] border-b border-white/10 text-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-cyan-300 text-xs font-semibold uppercase tracking-[.18em] mb-3">DR1FT für jede Rolle</p>
