...
export default function HomePage() {
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-10 sm:pt-16 pb-16 grid lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-14 items-center">
        <div>
          <p className="inline-flex bg-subtle border border-border text-xs font-medium text-ash px-3 py-1 rounded-full mb-6">
            Medienkompetenz für Schulen
          </p>
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.02]">
            Medienkompetenz, die Schüler:innen wirklich erleben.
          </h1>
          <p className="text-lg text-ash max-w-xl mt-6 leading-relaxed">
      ...
      <section id="produkt" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            { icon: Shield, title: "Sicher gestaltet", text: "Kein freies Kommentarfeld, kein Live-KI-Chat mit manipulativen Personas — jeder Dialog ist vorautoriert und redaktionell geprüft." },
          ...
          <div className="grid sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={n} className="text-center">
                <div className="w-10 h-10 rounded-full bg-ink text-white flex items-center justify-center font-display font-bold mx-auto mb-4">{n}</div>
      ...
      <section id="schulen" className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h2 className="font-display text-2xl font-bold mb-3">Für Schulen gemacht</h2>
